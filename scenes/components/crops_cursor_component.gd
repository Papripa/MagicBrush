...
@export var tilled_soil_tillmap_layer : TileMapLayer
...
func get_cell_under_mouse() -> void:
	mouse_position = tilled_soil_tillmap_layer.get_local_mouse_position()
	cell_position = tilled_soil_tillmap_layer.local_to_map(mouse_position)
	cell_source_id = tilled_soil_tillmap_layer.get_cell_source_id(cell_position)
	local_cell_position = tilled_soil_tillmap_layer.map_to_local(cell_position)
